ExecuteAFile ("slac_helper/qndhelper1.ibf");
...
#include "slac_helper/qndhelper2.ibf";
...
if (cOptions == 0) // SLAC
{
	...
	if (slacOptions)
	{
		ExecuteAFile("slac_helper/SGIvL.bf");
	}
	else
	{
		ExecuteAFile("slac_helper/SGEmulator.bf");
		...
		else
		{
			...
			else
			{
				...
				if (cOptions == 6)
				{
					...
					ExecuteAFile ("slac_helper/qndhelper3.ibf");
					...
					else
					{
                       ...
                       // VERBOSITY_LEVEL = 10;
						...
						else
						{
                            if (cOptions == 8)
                            {
                                ExecuteCommands ("slac_helper/qndhelper4.ibf");	
                                brOptions = 1;									
                                global			sFactor      = 1;
                                global			nFactor      = 1;
                                global 			nFactorOther = 1;
