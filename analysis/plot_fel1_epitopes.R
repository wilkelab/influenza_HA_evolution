...
id <- epitopes$Pos.1[!is.na(epitopes$Protein)]
id[id=='-'] <- 'None'
...
ggsave(p, file='~/Google Drive/Data/influenza_HA_evolution/analysis/b_nonhuman_epitopes_fel1.pdf', width=10, height=5)
...
ggsave(p, file='~/Google Drive/Data/influenza_HA_evolution/analysis/b_human_epitopes_fel1.pdf', width=10, height=5)
