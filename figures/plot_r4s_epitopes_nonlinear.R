...
id <- as.numeric(epitopes$rate4site[!is.na(epitopes$Protein)])
id[id <= 2] <- 'None'
id[!is.na(id) & !id == 'None'] <- 'P'
...
ggsave(p, file='~/Google Drive/Data/influenza_HA_evolution/analysis/b_human_epitopes_nonlinear_r4s.pdf', width=10, height=5)
